...
buttons = [
    ...
    [
        InlineKeyboardButton(text="About Seth", callback_data="emiko_"),
    ...
    [
        InlineKeyboardButton(
            text="GC MUTUALAN", url="https://t.me/ayomutualankawan"
        ),
    ],
    [
        InlineKeyboardButton(
            text="➗ Add Seth To Your Group ➗", url="t.me/SethRobot?startgroup=new"),
    ],
]
...
EMI_IMG = "https://telegra.ph/file/8aeed82bd3b692cd14a77.jpg"

DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project by contacting @xyzseth \
...
def emiko_about_callback(update, context):
    ...
    if query.data == "emiko_":
        query.message.edit_text(
            text="๏ I'm *Seth*, a powerful group management bot built to help you manage your group easily."
            ...
            "\n\n_Seth's licensed under the GNU General Public License v3.0_"
            "\n\n Click on button bellow to get basic help for SethRobot.",
            parse_mode=ParseMode.MARKDOWN,
        ...
        query.message.edit_text(
            ...
            "\nCongragulations, SethRobot now ready to manage your group."
            "\n\n*Admin Tools*"
        ...
        query.message.edit_text(
            text="*๏ Seth support chats*"
            "\nJoin My Support Group/Channel for see or report a problem on SethRobot.",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Support", url="t.me/sethproject"),
                    InlineKeyboardButton(text="Updates", url="https://t.me/sethXproject"),
                 ],
                 [
                    InlineKeyboardButton(text="Go Back", callback_data="emiko_"),
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Seth", url="t.me/xyzseth"),
                 ],
                 [
                    InlineKeyboardButton(text="Go Back", callback_data="emiko_"),
